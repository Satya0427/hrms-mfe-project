export const TOP_NAV_TABS_CONFIG = [
    /* ===== LEAVE ADMIN ===== */
    { subFeatureKey: 'LEAVE_ADMIN', key: 'LEAVE_TYPES', label: 'Leave Types', route: '/home/hrms-core/leave/leave-management' },
    { subFeatureKey: 'LEAVE_ADMIN', key: 'LEAVE_POLICIES', label: 'Leave Policies', route: '/home/hrms-core/leave/leave-policy' },
    { subFeatureKey: 'LEAVE_ADMIN', key: 'HOLIDAY_CALENDAR', label: 'Holiday Calendar', route: '/home/hrms-core/leave/holiday-calendar' },
